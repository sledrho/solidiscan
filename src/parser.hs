...
action_2 (24) = happyShift action_9
...
action_27 (49) = happyShift action_31
action_27 _ = happyFail

action_28 (49) = happyShift action_30
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	TReservedOp _ -> cont 17;
	TDec _ happy_dollar_dollar -> cont 18;
	TExp _ happy_dollar_dollar -> cont 19;
	TInt _ happy_dollar_dollar -> cont 20;
	TPragma _ -> cont 21;
	TImport _ -> cont 22;
	TPublic _ -> cont 23;
	TContract _ -> cont 24;
	TFuncDef _ -> cont 25;
	TBooleanLit _ -> cont 26;
	TTrue _ -> cont 27;
	TNegate _ -> cont 28;
	TAnd _ -> cont 29;
	TOr _ -> cont 30;
	...
	TExpSym _ -> cont 45;
	TModul _ -> cont 46;
	TOp _ happy_dollar_dollar -> cont 47;
	TSub _ -> cont 48;
	TSemiCol _ -> cont 49;
	TIdent _ happy_dollar_dollar -> cont 50;
	TStringLiteral _ happy_dollar_dollar -> cont 51;
	TLeftParen _ -> cont 52;
	TRightParen _ -> cont 53;
	_ -> happyError' (tk:tks)
	}
