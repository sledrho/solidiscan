...
data HappyAbsSyn t4 t5 t9 t15 t16 t17 t18 t19 t20 t21 t22 t23 t24 t25
	= HappyTerminal (Token)
	| HappyErrorToken Int
	| HappyAbsSyn4 t4
	| HappyAbsSyn5 t5
...
action_14 (68) = happyShift action_34
action_14 _ = happyFail

action_15 (68) = happyShift action_33
...
action_17 (41) = happyShift action_29
action_17 (42) = happyShift action_30
...
action_17 (20) = happyGoto action_22
action_17 (21) = happyGoto action_23
action_17 (22) = happyGoto action_24
...
action_18 (40) = happyShift action_28
action_18 (41) = happyShift action_29
action_18 (42) = happyShift action_30
action_18 (69) = happyShift action_31
action_18 (11) = happyGoto action_18
action_18 (12) = happyGoto action_19
action_18 (14) = happyGoto action_20
action_18 (15) = happyGoto action_21
action_18 (20) = happyGoto action_22
action_18 (21) = happyGoto action_23
action_18 (25) = happyGoto action_43
...
action_21 (34) = happyShift action_40
action_21 (35) = happyShift action_41
action_21 (36) = happyShift action_42
action_21 (16) = happyGoto action_37
action_21 (23) = happyGoto action_38
...
action_27 (69) = happyShift action_35
...
action_35 (69) = happyShift action_46
...
action_38 (69) = happyShift action_44
...
action_44 (61) = happyShift action_50
action_44 (18) = happyGoto action_48
action_44 (24) = happyGoto action_49
action_44 _ = happyReduce_37

action_45 (68) = happyShift action_47
...
action_49 (68) = happyShift action_53
action_49 _ = happyFail

action_50 (69) = happyShift action_52
...
happyReduction_18 (HappyAbsSyn20  happy_var_1)
	 =  HappyAbsSyn15
		 (happy_var_1
	)
...
happyReduction_19 (HappyTerminal (TPublic _ happy_var_1))
	 =  HappyAbsSyn16
...
happyReduction_20 (HappyTerminal (TPriv _ happy_var_1))
	 =  HappyAbsSyn16
...
happyReduction_21 (HappyTerminal (TIntern _ happy_var_1))
	 =  HappyAbsSyn16
...
happyReduction_22 (HappyTerminal (TConst _ happy_var_1))
	 =  HappyAbsSyn16
...
happyReduction_28 (HappyTerminal (TAddr _ happy_var_1))
	 =  HappyAbsSyn21
...
happyReduction_29 (HappyTerminal (TBooleanLit _ happy_var_1))
	 =  HappyAbsSyn21
...
happyReduction_31 (HappyTerminal (TStringAs _ happy_var_1))
	 =  HappyAbsSyn21
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	TReservedOp _ -> cont 26;
	TVers _ -> cont 27;
	TDec _ happy_dollar_dollar -> cont 28;
	TExp _ happy_dollar_dollar -> cont 29;
	TInt _ happy_dollar_dollar -> cont 30;
	TPragma _ -> cont 31;
	TImport _ -> cont 32;
	TPublic _ happy_dollar_dollar -> cont 33;
	TIntern _ happy_dollar_dollar -> cont 34;
	TPriv _ happy_dollar_dollar -> cont 35;
	TConst _ happy_dollar_dollar -> cont 36;
	TStringAs _ happy_dollar_dollar -> cont 37;
	TContract _ -> cont 38;
	TFuncDef _ -> cont 39;
	TAddr _ happy_dollar_dollar -> cont 40;
	TBooleanLit _ happy_dollar_dollar -> cont 41;
	TVar _ happy_dollar_dollar -> cont 42;
	TTrue _ -> cont 43;
	TFalse _ -> cont 44;
	TAs _ -> cont 45;
	THat _ -> cont 46;
